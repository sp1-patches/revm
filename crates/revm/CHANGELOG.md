...
## [4.0.0](https://github.com/succinctlabs/revm-private/compare/revm-v3.5.0...revm-v4.0.0) - 2024-02-01

### Added
- *(op)* Ecotone hardfork ([#1009](https://github.com/succinctlabs/revm-private/pull/1009))
- *(inspector)* Share call/create inputs in Inspector call_end/create_end ([#1003](https://github.com/succinctlabs/revm-private/pull/1003))
...
- *(ethersdb)* propagate errors instead of panicking in basic_ref ([#935](https://github.com/succinctlabs/revm-private/pull/935))
- *(revm)* implement prepend_state for BundleState ([#907](https://github.com/succinctlabs/revm-private/pull/907))
- add serde derives for `CacheDB` under "serde" flag ([#911](https://github.com/succinctlabs/revm-private/pull/911))
- *(examples)* generate block traces ([#895](https://github.com/succinctlabs/revm-private/pull/895))
- *(revm)* Evm Context Tests and test-utils Feature ([#903](https://github.com/succinctlabs/revm-private/pull/903))
...
- *(revm)* implement DatabaseRef trait for EthersDB ([#774](https://github.com/succinctlabs/revm-private/pull/774))

### Fixed
- *(State)* Preserve original values on delete revert ([#1010](https://github.com/succinctlabs/revm-private/pull/1010))
- optimism gas refunds ([#989](https://github.com/succinctlabs/revm-private/pull/989))
...
- fix typos in revm crate ([#821](https://github.com/succinctlabs/revm-private/pull/821))
- Optimism execution ([#789](https://github.com/succinctlabs/revm-private/pull/789))
- rename `DatabaseRef` trait functions to `*_ref` ([#795](https://github.com/succinctlabs/revm-private/pull/795))

### Other
- group handlers ([#1030](https://github.com/succinctlabs/revm-private/pull/1030))
- *(Inspector)* add inspector depth test ([#1028](https://github.com/succinctlabs/revm-private/pull/1028))
- *(op)* Move op l1 block load to op handler ([#1026](https://github.com/succinctlabs/revm-private/pull/1026))
- *(clippy)* nightly clippy ([#1025](https://github.com/succinctlabs/revm-private/pull/1025))
...
- *(Inspector)* Add return_memory_offset to Inspector::call ([#1006](https://github.com/succinctlabs/revm-private/pull/1006))
- update call end docs ([#1000](https://github.com/succinctlabs/revm-private/pull/1000))
- add getter for specId ([#998](https://github.com/succinctlabs/revm-private/pull/998))
- Remove preserve_order in serde_json ([#997](https://github.com/succinctlabs/revm-private/pull/997))
- update create docs ([#999](https://github.com/succinctlabs/revm-private/pull/999))
...
- set deduct_caller in optimism handler ([#988](https://github.com/succinctlabs/revm-private/pull/988))
...
- *(EvmBuilder)* Remove unnecessary BuilderStage trait ([#979](https://github.com/succinctlabs/revm-private/pull/979))
- enhance readability ([#968](https://github.com/succinctlabs/revm-private/pull/968))
- *(interpreter)* refactor sstore_cost ([#974](https://github.com/succinctlabs/revm-private/pull/974))
- *(interpreter)* improve enum naming ([#962](https://github.com/succinctlabs/revm-private/pull/962))
- *(deps)* bump anyhow from 1.0.77 to 1.0.79 ([#950](https://github.com/succinctlabs/revm-private/pull/950))
- relax Bytes requirement and use slice instead ([#937](https://github.com/succinctlabs/revm-private/pull/937))
- *(deps)* bump futures from 0.3.29 to 0.3.30 ([#927](https://github.com/succinctlabs/revm-private/pull/927))
- *(deps)* bump anyhow from 1.0.75 to 1.0.76 ([#921](https://github.com/succinctlabs/revm-private/pull/921))
- *(deps)* bump tokio from 1.34.0 to 1.35.0 ([#909](https://github.com/succinctlabs/revm-private/pull/909))
- *(revm)* leverage StorageSlot methods, where appropriate ([#899](https://github.com/succinctlabs/revm-private/pull/899))
- relax state generic ([#881](https://github.com/succinctlabs/revm-private/pull/881))
- clippy ([#877](https://github.com/succinctlabs/revm-private/pull/877))
- *(deps)* bump ethers-contract from 2.0.10 to 2.0.11 ([#867](https://github.com/succinctlabs/revm-private/pull/867))
...
- *(deps)* bump tokio from 1.33.0 to 1.34.0 ([#856](https://github.com/succinctlabs/revm-private/pull/856))
- change addresses to iterator and add into_addresses ([#855](https://github.com/succinctlabs/revm-private/pull/855))
- use keccak256 for blockhash ([#854](https://github.com/succinctlabs/revm-private/pull/854))
- review safety comments ([#811](https://github.com/succinctlabs/revm-private/pull/811))
- *(deps)* bump futures from 0.3.28 to 0.3.29 ([#839](https://github.com/succinctlabs/revm-private/pull/839))
- *(state)* consistent selfdestruct status transition ([#847](https://github.com/succinctlabs/revm-private/pull/847))
- *(state)* move account status transitions to `AccountStatus` ([#844](https://github.com/succinctlabs/revm-private/pull/844))
- *(state)* simplify control flow in `CacheState::apply_evm_state` ([#842](https://github.com/succinctlabs/revm-private/pull/842))
- Refactor precompile list from Hash to vec ([#823](https://github.com/succinctlabs/revm-private/pull/823))
- *(state)* make `State::apply_transition` pub ([#832](https://github.com/succinctlabs/revm-private/pull/832))
- *(state)* make bundle state non-optional ([#828](https://github.com/succinctlabs/revm-private/pull/828))
- Refactor evm data to its file ([#815](https://github.com/succinctlabs/revm-private/pull/815))
...
- remove `step` and `step_end` return result ([#804](https://github.com/succinctlabs/revm-private/pull/804))
- Instruction table ([#759](https://github.com/succinctlabs/revm-private/pull/759))
- getter for  field of ([#792](https://github.com/succinctlabs/revm-private/pull/792))
...
- *(deps)* bump tokio from 1.32.0 to 1.33.0 ([#785](https://github.com/succinctlabs/revm-private/pull/785))
- Use upstream create and create2 implementations ([#775](https://github.com/succinctlabs/revm-private/pull/775))
- reorder JournalState impl ([#772](https://github.com/succinctlabs/revm-private/pull/772))
